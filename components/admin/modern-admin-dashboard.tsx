      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <Card className="p-4 bg-gradient-to-br from-yellow-50 to-yellow-100 border-yellow-200">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-yellow-600 mt-1">Awaiting admin pricing</p>
              </div>
          ...
          <Card className="p-4 bg-gradient-to-br from-green-50 to-green-100 border-green-200">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-green-700 font-medium">Approved Orders</p>
                <p className="text-3xl font-bold text-green-900">{stats.approvedOrders}</p>
                <p className="text-xs text-green-600 mt-1">Ready for fulfillment</p>
              </div>
          ...
          <Card className="p-4 bg-gradient-to-br from-red-50 to-red-100 border-red-200">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-red-700 font-medium">Rejected Orders</p>
                <p className="text-3xl font-bold text-red-900">{stats.rejectedOrders}</p>
                <p className="text-xs text-red-600 mt-1">Declined orders</p>
              </div>
        ...
        <Card className="p-6">
          <div className="flex flex-col md:flex-row gap-4">
            <div className="relative flex-1">
              ...
              <Input
                placeholder="Search by order number, client, or salesman..."
                value={searchTerm}
            ...
            >
              ...
              <option value="salesman_adjusted">Salesman Adjusted</option>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Real-time order data from the system</CardDescription>
          </CardHeader>
          <CardContent>
